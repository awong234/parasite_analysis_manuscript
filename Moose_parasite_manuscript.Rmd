...
where the second arguemnt of the Normal distribution is specified on the
*precision* scale.

The priors for the Matern covariance parameters were specified using INLA's
penalized complexity prior construction for the range parameter $\rho$ and
marginal variance $\sigma$. 
